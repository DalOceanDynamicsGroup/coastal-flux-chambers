function poDat = processPO_v06_AIb(selPath)

% Reads raw Pro-Oceanus Solu-Blu data produced by Test_rs485_V0.6_AIb.py
% and outputs a timetable containing phase-averaged values. 
% User interactively chooses selPath.
% Optionally saves a .mat file.

% USAGE:
%   poDat = processPO_v06_AIb
%   poDat = processPO_v06_AIb(selPath)

% -------------------------------------------------------------------------
% Handle inputs
% -------------------------------------------------------------------------
projectRoot = 'C:\Users\Emily\OneDrive - Dalhousie University\Work\Dal and MIT\Lab Experiments\Data\';
