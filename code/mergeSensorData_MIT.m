...
mitDat = addvars(mitDat,mit_samplecorr_ppm);
...
TT_sync = TT_sync(:,{'pCO2','OceanusPCO2','TEMP1','TEMP2','pH',...
    'REFPCO2','SAMPLEPCO2','mit_samplecorr_ppm','REFTEMP','SAMPLETEMP','CALCULATEDFLUX'...
...
TT_5min.Properties.VariableNames = {'turner_ppm','miniCO2_water_ppm','air_T','water_T','pH'...
    'mit_ref_ppm','mit_sample_ppm','mit_samplecorr_ppm','mit_ref_T','mit_sample_T','mit_eos_flux'...
